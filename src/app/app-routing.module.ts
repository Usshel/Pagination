...
@NgModule({
  ...
  ]), RouteSortSingleProductsBackendComponentModule, SearchRouteMultiJobsComponentModule, RouteFilterSingleProductsBackendComponentModule, RouteFilterMultiCardsFrontendComponentModule],
